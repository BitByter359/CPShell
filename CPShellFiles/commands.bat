...
echo usertool - A user tool for creating, deleting and displaying users. (CP)
echo newboot - Enables Alternative boot animation on Windows(R) 11. (CP)
echo quick-uninstall - Uninstalls CPShell {}
echo.
